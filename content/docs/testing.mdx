...
flowchart TB
  ...
  style Ported fill:#1e3a5f,color:#bfdbfe
  style Domain fill:#14532d,color:#bbf7d0
  style Snapshot fill:#713f12,color:#fef08a
  style Property fill:#581c87,color:#e9d5ff
  style Fuzz fill:#7f1d1d,color:#fecaca
`} />
