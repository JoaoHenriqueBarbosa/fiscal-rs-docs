...
O fiscal-rs possui **692+ testes de integração** distribuídos em 16 arquivos de teste, além de **5 alvos de fuzzing**. A maioria dos testes foi portada diretamente das suítes PHP ([sped-nfe](https://github.com/nfephp-org/sped-nfe)) e TypeScript do FinOpenPOS, garantindo paridade funcional entre as implementações.

| Métrica | Valor |
|---------|-------|
| Testes de integração | 692+ |
| Arquivos de teste | 16 |
| Alvos de fuzzing | 5 |
| Linhas de código de teste | ~13.500 |
