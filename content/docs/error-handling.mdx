...
O `FiscalError` flui naturalmente das camadas internas para o código do usuário. Cada crate adiciona seus próprios erros usando `map_err` para converter erros de bibliotecas externas (RustCrypto, reqwest, etc.) em variantes de `FiscalError`.
