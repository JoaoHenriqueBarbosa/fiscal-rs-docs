...
[napi-rs](https://napi.rs) gera addons nativos para Node.js com definições TypeScript automáticas. A performance é 10-100x superior ao JavaScript puro para operações como geração de XML e cálculos fiscais.
