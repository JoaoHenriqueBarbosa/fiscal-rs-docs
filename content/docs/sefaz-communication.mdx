---
title: Comunicação com SEFAZ
description: Deep dive na comunicação com os webservices SEFAZ — ciclo de vida da requisição, catálogo de serviços, resolução de URLs por estado e parsing de respostas SOAP.
---
